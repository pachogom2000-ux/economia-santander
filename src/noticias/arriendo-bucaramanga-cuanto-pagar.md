...
excerpt: El arriendo solo puede subir 5,10% en 2026 y una vez cada doce meses.
  Cuánto del sueldo se puede destinar y qué argumentos sirven para negociar el
  ajuste.
autor: Francisco Gómez - Director
imagen: /assets/uploads/arriendo-santander.webp
imagenAlt: Pagar arriendo en Santander
imagenTitle: Pagar arriendo en Santander
imagenPie: "El arriendo de vivienda en Colombia solo puede subir 5,10% en 2026. "
imagenCredito: PIxabay
guia: true
tags: noticias
---
El arriendo de vivienda en Colombia **solo puede subir 5,10% en 2026**. Ese es el IPC con el que cerró 2025, [certificado por el DANE](https://www.dane.gov.co/files/operaciones/IPC/dic2025/cp-IPC-dic2025.pdf), y es el techo legal que fija la Ley 820 de 2003.
...
Si está mirando crédito de vivienda en lugar de arriendo, revise antes [qué es el UVR y cómo afecta su crédito hipotecario](/noticias/uvr-que-es-como-afecta-credito-hipotecario/). Y para entender de dónde sale el IPC que fija este tope, está el [glosario de IPC, DTF y tasa de usura](/noticias/glosario-ipc-dtf-usura-spread-bancario/).
