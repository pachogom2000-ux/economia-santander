...
El área metropolitana de Bucaramanga tiene una **informalidad del 44,5%**, según cifras del DANE citadas en [nuestra guía para declarar renta siendo independiente](/noticias/declarar-renta-independientes-santander/). Casi la mitad de los ocupados no tiene un salario fijo cada mes.
...
Si quiere entender de dónde sale cada tasa, está el [glosario de IPC, DTF, usura y spread bancario](/noticias/glosario-ipc-dtf-usura-spread-bancario/). Y si en lugar de deber está buscando dónde poner un ahorro, mire [dónde rinde más su plata en un CDT](/noticias/donde-rinde-mas-tu-plata-cdt-santander/).
